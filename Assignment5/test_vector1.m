...
The parameters are for the test vector 1 sent by Rohit.
...
dmrs_AdditionalPosition = "pos0";   % corresponds to dmrs-AdditionalPosition from Tables 7.4.1.1.2-3/4 TS 38.211, can be "pos{0/1/2/3}"
...
% PDSCH information
BWP_RBOffset =  0;                      % Offset of BWP from zeroth subcarrier of CRB0

...
The parameters are for the test vector 2 sent by Rohit.
...
N_ID_Cell = 100;         % Cell ID
nSCID = 1;              % Value of n_SCID, either 0 or 1
...
scramblingID0 = 30;                 % Givees N_ID^0, TS 38.331 DMRS-DownlinkConfig, belongs to {1,2...65535}
scramblingID1 = 30;                 % Givees N_ID^1, TS 38.331 DMRS-DownlinkConfig, belongs to {1,2...65535} 
...
dmrs_TypeAPosition = "pos3";        % corresponds to dmrs-TypeAPosition from, IE from MIB TS 38.331, either "pos2" or "pos3" 
...
% PDSCH information
BWP_RBOffset =  20;                     % Offset of BWP from zeroth subcarrier of CRB0
BWP_NumRBs = 256;                       % size of BWP in RBs, at most 275
mappingType = "TypeA";                  % PDSCH DMRS mapping type, either "TypeA" or "TypeB"
PDSCH_ResourceAllocationType = "Type1"; % Resource allocation type for PDSCH in f-domain, either "Type0" or "Type1"
...
PDSCH_NumOFDMSyms = 10;                  % PDSCH duration
